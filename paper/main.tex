...
In \cite{bendale2015open}, OpenMax was proposed as an alternative to the SoftMax operator using 
a statistical method apportion class probabilities to the open-set class. 
A k + 1 classifier for a k class problem was used where the extra class was treated
as the open-set class.  
...
prediction \cite{doersch2016unsuperviseddoersch2017multitask},

...
\begin{figure}
  ...
  \caption{\label{fig:step1} Schema representing the step 1 training}
\end{figure}
...
\begin{figure}[t]
  ...
  \caption{\label{fig:separation}\centering Schema representing the target images separation process}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{\label{fig:step2}\centering Test Caption}
\end{figure}
...
\begin{figure}[!htb]
  ...
  \end{subfigure}
  \caption{\centering\label{fig:hyperparams} HOS values for different parameters. For full reference see appendix \ref{sec:tables}}
\end{figure}

...
We evaluate the effectiveness of our proposed method exploiting the {\it Office-Home} {\bf INSERT REFERENCE} benchmark dataset,
...
For the feature extraction, we employ a ResNet-18 ({\bf INSERT REF}) pre-trained on ImageNet.

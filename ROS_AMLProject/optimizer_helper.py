...
def get_optim_and_scheduler(feature_extractor,rot_cls,obj_cls, epochs, lr, train_all, multihead, center_loss, criterion_center):
    ...
    if center_loss:
        params.extend(criterion_center.parameters())
